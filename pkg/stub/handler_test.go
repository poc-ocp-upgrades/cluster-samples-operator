...
var (
	conditions = []v1.ConfigConditionType{v1.SamplesExist, v1.ImportCredentialsExist, v1.ConfigurationValid, v1.ImageChangesInProgress, v1.RemovePending, v1.MigrationInProgress, v1.ImportImageErrorsExist}
)
...
func TestSkipped(t *testing.T) {
	...
	event.Object = &imagev1.ImageStream{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "openshift", Labels: map[string]string{}}, Spec: imagev1.ImageStreamSpec{Tags: []imagev1.TagReference{{From: &corev1.ObjectReference{Kind: "DockerImage"}}}}}
	h.Handle(event)
	importerror = cfg.Condition(v1.ImportImageErrorsExist)
...
func TestProcessed(t *testing.T) {
	...
	validate(true, err, "", cfg, conditions, []corev1.ConditionStatus{corev1.ConditionFalse, corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse}, t)
	err = h.Handle(event)
	validate(true, err, "", cfg, conditions, []corev1.ConditionStatus{corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse}, t)
	err = h.Handle(event)
	validate(true, err, "", cfg, conditions, []corev1.ConditionStatus{corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse}, t)
	fakeisclient := h.imageclientwrapper.(*fakeImageStreamClientWrapper)
	for _, key := range iskeys {
...
func TestImageStreamEvent(t *testing.T) {
	...
	tagVersion := int64(1)
	is := &imagev1.ImageStream{ObjectMeta: metav1.ObjectMeta{Name: "foo", Annotations: map[string]string{v1.SamplesVersionAnnotation: h.version}}, Spec: imagev1.ImageStreamSpec{Tags: []imagev1.TagReference{{Name: "foo", Generation: &tagVersion}}}, Status: imagev1.ImageStreamStatus{Tags: []imagev1.NamedTagEventList{{Tag: "foo", Items: []imagev1.TagEvent{{Generation: tagVersion}}}}}}
	...
	validate(true, err, "", cfg, conditions, statuses, t)
	statuses[3] = corev1.ConditionFalse
	is = &imagev1.ImageStream{ObjectMeta: metav1.ObjectMeta{Name: "bar", Annotations: map[string]string{v1.SamplesVersionAnnotation: h.version}}, Spec: imagev1.ImageStreamSpec{Tags: []imagev1.TagReference{{Name: "bar", Generation: &tagVersion}}}, Status: imagev1.ImageStreamStatus{Tags: []imagev1.NamedTagEventList{{Tag: "bar", Items: []imagev1.TagEvent{{Generation: tagVersion}}}}}}
	h.processImageStreamWatchEvent(is, false)
	validate(true, err, "", cfg, conditions, statuses, t)
}
func TestTemplateEvent(t *testing.T) {
	...
	validate(true, err, "", cfg, conditions, statuses, t)
	cache.ClearUpsertsCache()
	template := &templatev1.Template{ObjectMeta: metav1.ObjectMeta{Name: "bo"}}
	faketclient := h.templateclientwrapper.(*fakeTemplateClientWrapper)
...
func TestCreateDeleteSecretBeforeCR(t *testing.T) {
	...
	event.Object = &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: v1.SamplesRegistryCredentials, Namespace: "openshift", Annotations: map[string]string{v1.SamplesVersionAnnotation: h.version}, ResourceVersion: "a"}}
	err := h.Handle(event)
	validate(false, err, "Received secret samples-registry-credentials but do not have the Config yet", cfg, conditions, []corev1.ConditionStatus{corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionTrue, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse}, t)
	event.Deleted = true
	err = h.Handle(event)
	validate(false, err, "Received secret samples-registry-credentials but do not have the Config yet", cfg, conditions, []corev1.ConditionStatus{corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionTrue, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse}, t)
	event.Deleted = false
	...
	err = h.Handle(event)
	validate(true, err, "", cfg, conditions, []corev1.ConditionStatus{corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionTrue, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse}, t)
	processCred(&h, cfg, t)
	err = h.Handle(event)
	validate(true, err, "", cfg, conditions, []corev1.ConditionStatus{corev1.ConditionFalse, corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionTrue, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse}, t)
	err = h.Handle(event)
...
func processCred(h *Handler, cfg *v1.Config, t *testing.T) {
	...
	secret := &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: v1.SamplesRegistryCredentials, Namespace: "openshift", Annotations: map[string]string{v1.SamplesVersionAnnotation: h.version}, ResourceVersion: "a"}}
...
func TestSecretAPIError(t *testing.T) {
	...
	statuses := []corev1.ConditionStatus{corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionTrue, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse, corev1.ConditionFalse}
	validate(true, err, "", cfg, conditions, statuses, t)
	event.Object = &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: coreosPullSecretName, Namespace: coreosPullSecretNamespace, ResourceVersion: "a"}}
	fakesecretclient := h.secretclientwrapper.(*fakeSecretClientWrapper)
...
func TestImageStreamImportError(t *testing.T) {
	...
	two := int64(2)
	one := int64(1)
	streams := []*imagev1.ImageStream{{ObjectMeta: metav1.ObjectMeta{Name: "foo", Annotations: map[string]string{v1.SamplesVersionAnnotation: TestVersion}}, Spec: imagev1.ImageStreamSpec{Tags: []imagev1.TagReference{{Name: "1", Generation: &two}, {Name: "2", Generation: &one}}}, Status: imagev1.ImageStreamStatus{Tags: []imagev1.NamedTagEventList{{Tag: "1", Items: []imagev1.TagEvent{{Generation: two}}}, {Tag: "2", Conditions: []imagev1.TagEventCondition{{Generation: two, Status: corev1.ConditionFalse, Message: "Internal error occurred: unknown: Not Found", Reason: "InternalError", Type: imagev1.ImportSuccess}}}}}}, {ObjectMeta: metav1.ObjectMeta{Name: "foo", Annotations: map[string]string{v1.SamplesVersionAnnotation: TestVersion}}, Spec: imagev1.ImageStreamSpec{Tags: []imagev1.TagReference{{Name: "1", Generation: &two}, {Name: "2", Generation: &one}}}, Status: imagev1.ImageStreamStatus{Tags: []imagev1.NamedTagEventList{{Tag: "1", Conditions: []imagev1.TagEventCondition{{Generation: two, Status: corev1.ConditionFalse, Message: "Internal error occurred: unknown: Not Found", Reason: "InternalError", Type: imagev1.ImportSuccess}}}, {Tag: "2", Conditions: []imagev1.TagEventCondition{{Generation: two, Status: corev1.ConditionFalse, Message: "Internal error occurred: unknown: Not Found", Reason: "InternalError", Type: imagev1.ImportSuccess}}}}}}, {ObjectMeta: metav1.ObjectMeta{Name: "foo", Annotations: map[string]string{v1.SamplesVersionAnnotation: TestVersion}}, Spec: imagev1.ImageStreamSpec{Tags: []imagev1.TagReference{{Name: "1", Generation: &two}, {Name: "2", Generation: &one}, {Name: "3", Generation: &one}}}, Status: imagev1.ImageStreamStatus{Tags: []imagev1.NamedTagEventList{{Tag: "1", Conditions: []imagev1.TagEventCondition{{Generation: two, Status: corev1.ConditionFalse, Message: "Internal error occurred: unknown: Not Found", Reason: "InternalError", Type: imagev1.ImportSuccess}}}, {Tag: "2", Conditions: []imagev1.TagEventCondition{{Generation: two, Status: corev1.ConditionFalse, Message: "Internal error occurred: unknown: Not Found", Reason: "InternalError", Type: imagev1.ImportSuccess}}}}}}}
...
func mimic(h *Handler, topdir string) {
	...
	fakefile.files = map[string][]fakeFileInfo{topdir: {{name: "imagestreams", dir: true}, {name: "templates", dir: true}}, topdir + "/" + "imagestreams": {{name: "foo", dir: false}, {name: "bar", dir: false}}, topdir + "/" + "templates": {{name: "bo", dir: false}, {name: "go", dir: false}}}
	fakeisgetter := h.Fileimagegetter.(*fakeImageStreamFromFileGetter)
	foo := &imagev1.ImageStream{ObjectMeta: metav1.ObjectMeta{Name: "foo", Labels: map[string]string{}}, Spec: imagev1.ImageStreamSpec{DockerImageRepository: registry1, Tags: []imagev1.TagReference{{From: &corev1.ObjectReference{Kind: "DockerImage"}}}}}
	bar := &imagev1.ImageStream{ObjectMeta: metav1.ObjectMeta{Name: "bar", Labels: map[string]string{}}, Spec: imagev1.ImageStreamSpec{DockerImageRepository: registry2, Tags: []imagev1.TagReference{{From: &corev1.ObjectReference{Name: registry2, Kind: "DockerImage"}}}}}
	fakeisgetter.streams = map[string]*imagev1.ImageStream{topdir + "/imagestreams/foo": foo, topdir + "/imagestreams/bar": bar, "foo": foo, "bar": bar}
	faketempgetter := h.Filetemplategetter.(*fakeTemplateFromFileGetter)
	bo := &templatev1.Template{ObjectMeta: metav1.ObjectMeta{Name: "bo", Labels: map[string]string{}}}
	gogo := &templatev1.Template{ObjectMeta: metav1.ObjectMeta{Name: "go", Labels: map[string]string{}}}
...
func NewTestHandler() Handler {
	...
	cvowrapper.state = &configv1.ClusterOperator{TypeMeta: metav1.TypeMeta{APIVersion: configv1.SchemeGroupVersion.String(), Kind: "ClusterOperator"}, ObjectMeta: metav1.ObjectMeta{Name: "goo", Namespace: "gaa"}, Status: configv1.ClusterOperatorStatus{Conditions: []configv1.ClusterOperatorStatusCondition{}}}
	...
	h.imageclientwrapper = &fakeImageStreamClientWrapper{upsertkeys: map[string]bool{}, streams: map[string]*imagev1.ImageStream{}, geterrors: map[string]error{}, listerrors: map[string]error{}, upserterrors: map[string]error{}}
	h.templateclientwrapper = &fakeTemplateClientWrapper{upsertkeys: map[string]bool{}, templates: map[string]*templatev1.Template{}, geterrors: map[string]error{}, listerrors: map[string]error{}, upserterrors: map[string]error{}}
...
func (f *fakeResourceFileLister) List(dir string) ([]os.FileInfo, error) {
	...
	for _, fi := range files {
		tfi := fakeFileInfo{name: fi.name, size: fi.size, mode: fi.mode, modeTime: fi.modeTime, sys: fi.sys, dir: fi.dir}
		fis = append(fis, &tfi)
	}
	return fis, nil
}
