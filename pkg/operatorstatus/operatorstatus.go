...
func (o *ClusterOperatorHandler) UpdateOperatorStatus(cfg *v1.Config) error {
	...
	err = o.setOperatorStatus(configv1.OperatorDegraded, failing, msgForFailing, "")
	if err != nil {
		return err
	}
